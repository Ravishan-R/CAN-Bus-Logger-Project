...
- Transmit and receive standard and extended CAN frames

### 2. Data Capture & Logging
- Capture live CAN bus traffic using SavvyCAN
- Log time-stamped CAN data to CSV or SD card
...
- Send CAN data to a cloud platform (AWS IoT Core / InfluxDB)
- Enable remote monitoring via a web dashboard
...
|----------|--------------------------|-------------------------------------------|
| Hardware | ESP32, MCP2515            | Stable CAN communication at 500 kbps      |
...
| Dashboard| Grafana / Plotly Dash     | Real-time monitoring and alerts           |
...
- ✅ GitHub repository with full documentation and demo video
...
- **LinkedIn:** https://www.linkedin.com/in/ravishan-rathnayakeprs
- **Portfolio:** https://ravishan-r.github.io/Portfolio/

---

> _This README will evolve as the project grows. Each goal will be checked off upon completion, and new stretch goals may be added._
